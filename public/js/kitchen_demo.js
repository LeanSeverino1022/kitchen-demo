...
$(document).ready(function () {
    ...
    // backsplash
    $('#backsplash .options-container').on('click', '.item-color-option', function() {
    ...
    // cabinet
    $('#cabinet .options-container').on('click', '.item-color-option', function() {
    ...
    let optionsRequest = function ($) {
        ...
        const o2 = $(".item-color-option.active[data-target='o2']").data().color;  //cabinet    
        const o3 = $(".item-color-option.active[data-target='o3']").data().color;  //backsplash    
        ...
        xhr = abortableWhen(jQuery, [
            ...
            jQuery.get(`https://everthreadapi.com/calibration/preview2.php?r5d=54&augmentID=2220&format=NOTbase64&patternID=1&isThumb=0&color1=&color2=&color3=&color4=&scaleSize=1&${constructQueryString([o1, o2, o3])}`),
        ]);
